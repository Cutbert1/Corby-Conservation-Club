...
```
![Image showing the output of the program](./assets/images/readme-images/features/navbar-mobile.jpg). ![Image showing the output of the program 768px and above](./assets/images/readme-images/features/navbar-tablets.jpg)
...
```
![Image showing the output of the program](./assets/images/readme-images/features/footer-mobile-screen.jpg)
#### Buttons and Links
...
```
![Image showing the output of the program](./assets/images/readme-images/features/donate-button.jpg). ![Image showing the output of the program](./assets/images/readme-images/features/get-involved-button.jpg).
#### Image and Video Gallery
Gallery is a page dedicated to green and animal conservation images and vidoes compiled with Masonry redesign style with column counts for different screen sizes. "alt" attribute and vidoe titles included to describe the images and enable screen reader to read out the description of the image for visually impaired users.
```html
<section id="gallery">
    ...
    <div id="pictures">
        ...
        <iframe src="https://www.youtube.com/embed/lzVWXyXnarI" title="Go green your way"></iframe>
        ...
        <iframe src="https://www.youtube.com/embed/XALBGkjkUPQ" title="Conservation International"></iframe>
        <img src="assets/images/animal-rescue.jpg" alt="Our people ready for animal rescue">
        ...
        <img src="assets/images/splash.jpg" alt="Corby Conservation union at cave of good hope south Africa">
        <iframe src="https://www.youtube.com/embed/lECg3mqchzY" title="About Environment"></iframe>
        <img src="assets/images/plant-the-world.jpg" alt="Plant a tree every week">
        <img src="assets/images/no-oil.jpg" alt="no arctic oil">
        <img src="assets/images/our-people.jpg" alt="our volunteers">       
            </div>
</section>
```
![Image showing the output of the program](./assets/images/readme-images/features/gallery-page.jpg).
#### Register Form
...
```
![Image showing the output of the program](./assets/images/readme-images/features/registration-form.jpg).
#### Donate Form
...
```
![Image showing the output of the program](./assets/images/readme-images/features/donate-page.jpg)
...
|:------------|:----------------|:-------------|:------------|
|Mobile|![lighthouse report mobile](./assets/images/readme-images/Lighthouse-images/lighthouse-report-mobile.jpg)|Reseized background images for home page (hero-image, donation-page, and register page) to reduce size styled CSS to fit. Removed dormant CSS  declarations.|![lighthouse mobile clear report](./assets/images/readme-images/Lighthouse-images/lighthouse-clear-report-mobile.jpg)|
|Desktop|![lighhouse report desktop](./assets/images/readme-images/Lighthouse-images/lighthouse-report-desktop.jpg)|Reseized background images for home page (hero-image, donation-page, and register page) to reduce size styled CSS to fit. Removed dormant CSS  declarations.|![lighthouse desktop clear report](./assets/images/readme-images/Lighthouse-images/lighthouse-clear-report-desktop.jpg)|

### Validation Testing
|Page Tested|Screenshot of Errors and Warnings   |Solution Applied|Screenshot of clear Validation Output|
|:------------|:----------------|:-------------|:------------|
|Index.html|![index-html error one](./assets/images/readme-images/code-validation-images/index-html-error-one.jpg) ![index-html error three](./assets/images/readme-images/code-validation-images/index-html-error-three.jpg) ![index-html error two](./assets/images/readme-images/code-validation-images/index-html-error-two.jpg) ![index-html warnings](./assets/images/readme-images/code-validation-images/index-html-warnings.jpg)| **1**. Comment out section attribute from section end tag and moved attribute to opening tag.<br> **2** Add closing tag on section element <br> **3**. Comment out the open p element nested in main element.<br>**4**. Comment out h3 elements in event section and replaced with p element to nest the favicons|![index-html clear validation output](./assets/images/readme-images/code-validation-images/index-html-clear-validation-output.jpg)
|Gallery.html|  No Error or Warning|Not Applicable |![gallery-html clear error validation output](./assets/images/readme-images/code-validation-images/gallery-html-clear-validation-output.jpg)
|Register.html|No Error or Warning|Not Applicable|![register-html clear error validation output](./assets/images/readme-images/code-validation-images/register-html-clear-validation-output.jpg)
|Aboutus.html|No Error or Warning|Not Applicable |![about us-html clear validation output](./assets/images/readme-images/code-validation-images/aboutus-html-clear-validation-output.jpg)
|Donate.html| **No Error**, two Warnings ![donate-html warnings](./assets/images/readme-images/code-validation-images/donate-html-warnings.jpg)| None, as these are warnings|![donate-html warning](./assets/images/readme-images/code-validation-images/donate-html-warnings.jpg)
|Thank-you.html|No Error or Warning|Not Applicable|![thank-you validation output](./assets/images/readme-images/code-validation-images/thank-you-clear-validation-output.jpg)|
|Style.css|No Error|Not Applicable|![style-css validation output](./assets/images/readme-images/code-validation-images/style-css-clear-validator-output.jpg)|
...
|:------------|:----------------|:-------------|:------------|
|#register background image styling|#register id was styled with height: 850px and media query 768px and up background position :centre;  but the image was cutting off when the screen size increases to 1291px. ![#register bug](./assets/images/readme-images/bugs-images/register-bug.jpg)|Image resized  and height updated to 100vh, media query 768px and up, background position updated to top.|Bug resolved: ![#register bug fix](./assets/images/readme-images/bugs-images/register-bug-fix.jpg)|
|#donation-from, maximum character for card and CVC number|Card and CVC field were taken more that 16  and 3 characters respectively. ![donate form bug](./assets/images/readme-images/bugs-images/donate-form-bug.jpg)|Updated input type to text, declared  inputmode=numneric, maxlenght=16 and 3 respectively.|![donate form bug fix](./assets/images/readme-images/bugs-images/donate-form-bug-fix.jpg)|
|#donation styling not pushing down to the footer|Position declaration caused a gap between #donation and footer element. ![donation form bug 2](./assets/images/readme-images/bugs-images/donate-formm-bug.jpg)|Comment out  position: fixed; and declared height:100vh; in stylesheet|![donation form bug fix 2](./assets/images/readme-images/bugs-images/donate-formm-bug-fix.jpg)|
...
|Bug|   Description |Solution Applied|Result|
|:------------|:----------------|:-------------|:------------|
|Thank you page, background image zoom out on large screen sizes|Background image  zooms out as the screen size increases, hence bottom of image not visible enough on large screen. ![Wide screen](./assets/images/readme-images/bugs-images/wide-screen-bug.jpg) ![image bottom not visible](./assets/images/readme-images/bugs-images/not-visible.jpg)|Added media query styling for 570px and up. Resized and compressed the image. Prospective solution: Change background to an image that has space at the bottom with none important imagery details|Unresolved.|
